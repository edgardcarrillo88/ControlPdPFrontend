...
export default function valorizaciones() {
    ...
    const sendfile = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/files/valorizaciones`, newfile)
        ...
        const DeleteAllData = async() =>{
            const response = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/files/deleteallEdp`)
            console.log(response);
        }
        ...
        <>
            <Stateoptions>
                ...
                <div className={styles.dropcontainer}>
                    <p className={styles.droptitle}>Cargar formato estandar de EDP</p>
            ...
            <button onClick={DeleteAllData}> Borrar datos de EDP</button>
        </>
    )
};
